...
<div class="main-panel">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title mb-0">
                      Data Barang yang digadaikan hari ini 
                    </p>
    ...
    <?php endif; ?>
                        ...
                        <td><a href="cetak_pdf.php?id_barang=<?= urlencode($data['id_barang']); ?>" target="_blank" style="text-decoration: none; color: blue;"><i class="mdi mdi-file"></i> Cetak Surat </a></td>
                        <td>
                                              <a class="btn" href="hapus_barang_gadai.php?id_barang=<?= urlencode($data['id_barang']); ?>" onclick="return confirm('Yakin Akan Menghapus Data Ini?')" style="font-size: 14px; color: white; padding: 8px 12px; background-color: #152453;">Hapus</a>
