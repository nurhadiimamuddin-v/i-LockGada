  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEditRahinLabel">Edit Orang yang Menggadaikan</h5>
      ...
      <form action="edit_rahin.php" method="POST">
        <div class="modal-body">
          <input type="hidden" id="editIdRahin" name="id_rahin">
                   <div class="mb-3">
           <label for="nama_rahin" class="form-label">Nama Rahin</label>
           <input type="text" class="form-control" id="nama_rahin" name="nama_rahin" placeholder="Masukkan Nama Orang yang Menggadaikan" required>
         </div>
           <div class="mb-3">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2>Data Nasabah (Orang yang menggadaikan)</h2>
                    <p class="mb-md-0"> Data Nasabah (Orang yang menggadaikan) dengan menggunakan tabel </p>
                  </div>
                  <div class="d-flex">
                    <img src="images/ty.png" alt="logo" style="height: 63px; margin-left: 350px;" class="d-none d-md-block">
                  </div>
                </div>
               </div>
            ...
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title mb-0">Data nasabah (Orang yang menggadaikan)</p>
...
<div class="modal fade" id="modalTambahRahin" tabindex="-1" aria-labelledby="modalTambahRahinLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalTambahRahinLabel">Tambah Locker</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
