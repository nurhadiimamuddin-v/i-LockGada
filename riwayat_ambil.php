...
<td>
        <a class="btn" href="cetak_surat.php?id_barang_diambil=<?= $data['id_barang_diambil']; ?>" target="_blank" style="font-size: 15px; color: white; padding: 8px 12px; background-color: #73bf43;">
        <i class="mdi mdi-file">
        </i> Surat Barang di ambil</a>
        </td>
      </tr>
    <?php } ?>
  </tbody>
