  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="nasabah_dashboard.php">
              <i class="mdi mdi-home menu-icon"></i>
              <span class="menu-title">Home</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="rahin.php">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="barang_digadai.php">Barang akan di gadaikan</a></li>
                <li class="nav-item"> <a class="nav-link" href="barang_diterima.php">Barang Akan di ambil</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="barang_yg_digadaikan.php">
              <i class="mdi mdi-view-headline menu-icon"></i>
              <span class="menu-title">Barang digadaikan</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="barang_yg_diambil.php">
